...
![Example Rmd file](example_rmd.png)
...
![Rendered example Rmd file](example_rendered_rmd.png)
...
![default rendered output](default_rendered_output.png).
...
![eval = FALSE output](eval_false.png)
...
````
would render 
![echo = FALSE output](echo_false.png)
