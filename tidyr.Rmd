...
#### Example
If for example we have a data frame containing multiple time series stored in columns. The first column contains dates, and subsequent columns are independent time series each with a name. The column headers are the variable names.

A visual representation would look like this:

t  | X | Y | Z
--- | --- | --- | ---
2009-01-01 | -1.8763317 | -0.1885183 | -6.655663
2009-01-02 | -1.3566227 | -2.1851226 | -3.863576
2009-01-03 | -1.3447188 | 2.4180249  | -1.543931

The R code for the data frame can be obtained by typing the code below:
```{r}
